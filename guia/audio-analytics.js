(() => {
  ...
  const configuredStationId = script?.dataset.stationId || '';
  ...
  whenReady(() => {
    ...
    const rawStation = (new URLSearchParams(window.location.search).get('station') || configuredStationId).replace(/\D/g, '');
